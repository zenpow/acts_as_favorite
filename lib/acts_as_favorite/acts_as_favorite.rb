...
module ActsAsFavorite
  ...
  module UserExtensions
    ...
    module InstanceMethods
      ...
      alias add_favorite has_favorite
      alias remove_favorite has_no_favorite
...
ActiveRecord::Base.send :include, ActsAsFavorite::UserExtensions, ActsAsFavorite::ModelExtensions
